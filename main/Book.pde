class Book{
  ...
  */
  ...
  Book(){
    // Set variables
    name = "Portefeuille Historique de l'Ornament";
    author = "Maxime Metzmacher";
    //collaborators.setString("");
    editor = "A. Lévy";
    language = "French";
    locationInLibrary = "Old Library";
    date = "1881";
    dimensions.setInt("height", 47);
    dimensions.setInt("width", 32);
    dimensions.setInt("width_spine", 2);
    numberOfPages = 100;
    referenceNumber = "OB 1633 - 7.048";
    description = "24 reproductions of engravings on Japanese paper pasted. Each of the engravings contain 16th, 17th and 18th century.";
    //images
    placeholder = loadImage("images/portefeuille.png");
  ...
  void showBookDetails(){
    ...
    text("Recueil complet des meilleurs motifs : Dessinés et gravés d'après les anciens maîtres", xSecondScreen + 258, 293, 274, 42);
